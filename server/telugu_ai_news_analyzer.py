    ...
    def run(analysis: Dict[str, Any], repair_log: List[Dict[str, Any]], logger: logging.Logger) -> List[Dict[str, Any]]:
        ...
        if cat and cat not in ALLOWED_CATEGORIES:
            ...
            if fixed and fixed in ALLOWED_CATEGORIES:
                ...
                repair_log.append({"field": "category", "original": orig, "repaired": "Other", "type": "category_fallback", "timestamp": _current_timestamp()})
                results.append(ValidationEngine._result("INFO", "category", f"Unknown category {orig} -> Other", True, True))
